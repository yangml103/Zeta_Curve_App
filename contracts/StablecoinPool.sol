 ...
 * @dev A Curve-like pool for swapping between different stablecoins on ZetaChain.
 * This pool uses the StableSwap invariant (x^3*y + y^3*x >= k) for efficient
 * stablecoin swaps with low slippage.
 */
contract StablecoinPool is Ownable, ReentrancyGuard {
    ...
    /**
     * @dev Constructor to create a new StablecoinPool
